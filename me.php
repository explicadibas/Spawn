...
<html lang="en">
    <head>
        ...
        <title>Spawn - Minha Empresa</title>
                                                ...
                                                <tr class="linhatabela">
                                                    <td rowspan="2">  
                                                        <?php
                                                            ...
                                                            if($imgperfil == ""){
                                                                echo "<img class=imgperfil src=upload/teste2.jpg>";
                                                            } else {
                                                                echo "<img class=imgperfil src=upload/$imgperfil>";
                                                            }  
                                                        ?>
                                                    </td>
                                                </tr>
          ...
          <div class="col s12 m6 offset-m3">
            <div class="card">
              ...
              <div class="card-image">
                <a href="#">
                <img src="img/criacao-imagem.jpeg">
                </a>
              </div>

              <div class="card-content">
              <span class="card-title bloco">Visualizar Empresa</span>  
              <p>
              ...
              <div class="card-action">
                <a class="linkME" href="#">Visualizar</a>
              </div>
        ...
        <a href="#">
          <div  class="row me">
            <div class="col s12 m6 offset-m3">
              <div class="card">
                <div class="card-image">
                  <img src="img/criacao-imagem.jpg">
                  
                  <a class="btn-floating halfway-fab waves-effect waves-light blue left"><i class="material-icons">add</i></a>
                </div>

                <div class="card-content">
                  <span class="card-title bloco">Crie uma nova empresa</span>  
                  <p style="text-indent: 1.5em;">Funda uma nova empresa do zero, contrate funcionários, </p>
                </div>
              </div>
            </div>
          </div>
